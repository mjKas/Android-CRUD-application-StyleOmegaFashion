...
public class MainActivity extends AppCompatActivity
        ...
        private static final String URL_DATA = "https://api.myjson.com/bins/utua8";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_DATA, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try{
                    ...
                    JSONArray jsonArray = jsonObject.getJSONArray("Omega"); //ArrayKey here
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            startActivity(new Intent(this,Ladies.class));
            // Handle the camera action
        } else if (id == R.id.nav_gents) {
            startActivity(new Intent(this,ActivityGents.class));
